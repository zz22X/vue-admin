  ...
  <div class="info_dialog">
    ...
    >
      ...
      >
        ...
        <el-form-item label="禁启用状态" prop="isAdmin">
          <el-switch v-model="data.form.isAdmin" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
        </el-form-item>
      </el-form>
...
export default {
  ...
  setup(props, { root, emit, refs }) {
    ...
    */
    ...
    //打开时
    const open = () => {
      data.form.email = data.editData.email;
      data.form.name = data.editData.name;
      data.form.phone = data.editData.phone;
      data.form.role = data.editData.role;
      data.form.isAdmin = data.editData.isAdmin;
      data.form.area = data.editData.area;
    };
    //打开动画结束后
    const poened = () => {};
    const cancelAddNew = () => {
